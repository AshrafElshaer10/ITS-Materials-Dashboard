...
with st.form(key ="input_form", clear_on_submit= True): # "clear_on_submit" to remove inserted values & be ready for new vlaues
    ...
    database_without_calculations['Total_Sales(EGP)'] = (database_without_calculations['Actual_QTY.'] * database_without_calculations['Targeted_Unit_Sale(EGP)']).round(2)
    ...
    database_without_calculations['Total_Targeted_Gross_Profit(EGP)'] = (database_without_calculations['Total_Sales(EGP)'] - database_without_calculations['BAC = Budget @ Completion (EGP)']).round(2)
    ...
    database_without_calculations['Actual_Sales_Progress(EGP)'] = (database_without_calculations['Total_Sales(EGP)'] * database_without_calculations['Progress (%)']).round(2)
...
Nuemrical_Filter0 = st.multiselect('', ['Total_Expected_Gross_Profit(EGP)','Progress (%)','BAC = Budget @ Completion (EGP)','Qty._Variance','Total_Sales(EGP)',
...
with c1:
    ...
    num_filter1 = num_filter1.selectbox('Values:', ['Total_Expected_Gross_Profit(EGP)','Progress (%)','BAC = Budget @ Completion (EGP)','Qty._Variance','Total_Sales(EGP)',
                                                    'Sales_Variance(EGP)','AC = Actual_Cost_To_Date(EGP)','EV = Earned Value (EGP)','CPI = Cost Performance index',
                                                    'TCPI = To Complete Performance index','CV = Cost Variance (EGP)','EAC = Estimated @ Completion (EGP)',
                                                    'ETC = Estimate Cost to complete (EGP)','VAC = Variance @ Completion (EGP)','Total_Targeted_Gross_Profit(EGP)',
                                                    'Actual_Sales_Progress(EGP)'], key='num_filter1') ## Adding key parameter to each st.select box call to ensure each widget has a unique key for c1, c2, c3.
...
with c2:
    ...
    num_filter2 = num_filter2.selectbox('Values:', ['Total_Expected_Gross_Profit(EGP)','Progress (%)','BAC = Budget @ Completion (EGP)','Qty._Variance','Total_Sales(EGP)',
                                                    'Sales_Variance(EGP)','AC = Actual_Cost_To_Date(EGP)','EV = Earned Value (EGP)','CPI = Cost Performance index',
                                                    'TCPI = To Complete Performance index','CV = Cost Variance (EGP)','EAC = Estimated @ Completion (EGP)',
                                                    'ETC = Estimate Cost to complete (EGP)','VAC = Variance @ Completion (EGP)','Total_Targeted_Gross_Profit(EGP)',
                                                    'Actual_Sales_Progress(EGP)'], key='num_filter2') ## Adding key parameter to each st.select box call to ensure each widget has a unique key for c1, c2, c3.
...
with c3:
    ...
    num_filter3 = num_filter3.selectbox('Values:', ['EV = Earned Value (EGP)','Total_Expected_Gross_Profit(EGP)','Progress (%)','BAC = Budget @ Completion (EGP)','Qty._Variance','Total_Sales(EGP)',
                                                    'Sales_Variance(EGP)','AC = Actual_Cost_To_Date(EGP)','CPI = Cost Performance index',
                                                    'TCPI = To Complete Performance index','CV = Cost Variance (EGP)','EAC = Estimated @ Completion (EGP)',
                                                    'ETC = Estimate Cost to complete (EGP)','VAC = Variance @ Completion (EGP)','Total_Targeted_Gross_Profit(EGP)',
                                                    'Actual_Sales_Progress(EGP)'], key='num_filter3') ## Adding key parameter to each st.select box call to ensure each widget has a unique key for c1, c2, c3.
...
x_axis_num_filter = f1.selectbox('X_axis_Value:', ['Total_Sales(EGP)','Actual_Sales_Progress(EGP)','QTY._As _Per_Contract','Actual_Qty.','Progress (%)','BAC = Budget @ Completion (EGP)','Qty._Variance',
                                                    'Sales_Variance(EGP)','AC = Actual_Cost_To_Date(EGP)','EV = Earned Value (EGP)','CPI = Cost Performance index',
...
y_axis_num_filter = f2.selectbox('Y_axis_Value:', ['Total_Expected_Gross_Profit(EGP)','Progress (%)','BAC = Budget @ Completion (EGP)','Qty._Variance','Total_Sales(EGP)',
                                                    ...
                                                    'ETC = Estimate Cost to complete (EGP)','VAC = Variance @ Completion (EGP)','Total_Targeted_Gross_Profit(EGP)',
                                                    'Actual_Sales_Progress(EGP)'])
num_filter = f3.selectbox('Numerical Filtering:', ['Total_Expected_Gross_Profit(EGP)','Progress (%)','BAC = Budget @ Completion (EGP)','Qty._Variance','Total_Sales(EGP)',
                                                   'Sales_Variance(EGP)','AC = Actual_Cost_To_Date(EGP)','EV = Earned Value (EGP)','CPI = Cost Performance index',
                                                   'TCPI = To Complete Performance index','CV = Cost Variance (EGP)','EAC = Estimated @ Completion (EGP)',
                                                   'ETC = Estimate Cost to complete (EGP)','VAC = Variance @ Completion (EGP)','Total_Targeted_Gross_Profit(EGP)',
                                                   'Actual_Sales_Progress(EGP)'])
